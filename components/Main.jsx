      ...
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          ...
          <div className="flex items-center justify-between mx-auto max-w-[330px] py-4">
            <a href="https://www.linkedin.com/in/0xprakharg/" target="_blank" rel="noreferrer">
            ...
            <a href="https://github.com/0xPrakharG" target="_blank" rel="noreferrer">
              <div className="rounded-full shadow-lg shadow-gray-400 p-6 flex text-[#5651e5] cursor-pointer hover:scale-105 ease-in duration-300">
                <FaGithub size={20} />
              </div>
            </a>
            <a href="https://twitter.com/0xPrakharG" target="_blank" rel="noreferrer">
              <div className="rounded-full shadow-lg shadow-gray-400 p-6 flex text-[#5651e5] cursor-pointer hover:scale-105 ease-in duration-300">
                <FaTwitter size={20} />
              </div>
            </a>
            <a href="mailto:prakhargoyal.3014@gmail.com" target="_blank" rel="noreferrer">
              <div className="rounded-full shadow-lg shadow-gray-400 p-6 flex text-[#5651e5] cursor-pointer hover:scale-105 ease-in duration-300">
                <AiOutlineMail />
              </div>
            </a>
