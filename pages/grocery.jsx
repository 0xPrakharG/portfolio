    ...
    <div className="w-full ">
      ...
      <div className="max-w-[80%] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <a href="http://grocery-bud-tau.vercel.app/" target="_blank" rel="noreferrer">
            <button className="px-4 py-2 mt-4 mr-8 ">Demo</button>
          </a>
          <a href="https://github.com/Prakhar-Goyal-3014/grocery_bud" target="_blank" rel="noreferrer">
